...
class BookingMedecinScreen extends StatefulWidget {
  static const String routeName = '/changer-reservation-medecin';
  final Appointment appointment;
  BookingMedecinScreen({Key? key, required this.appointment}) : super(key: key);

  @override
  State<BookingMedecinScreen> createState() => _BookingMedecinScreenState();
}
