...
class AppointmentScreen extends StatefulWidget {
  static const String routeName = '/rendez-vous';
...
class _AppointmentScreenState extends State<AppointmentScreen> {
  ...
  fetchAllAppointment() async {
    schedules = await appointmentService.fetchAllAppointmentsByUserId(context);
    filterAppointment();
                            ...
                            children: [
                              ...
                              Expanded(
                                child: OutlinedButton(
                                  ...
                                  onPressed: () {
                                    setState(() {
                                      appointmentService.updateAppointmentStatus(context, schedule.id,'complet');
                                      schedule.status = 'complet';
                                      filterAppointment();
                                    });
                                  },
                                  child: const Text(
