...
class HomeScreenMedAdmin extends StatefulWidget {
  static const String routeName = '/home-med-admin';
  const HomeScreenMedAdmin({Key? key}) : super(key: key);

  @override
  State<HomeScreenMedAdmin> createState() => _HomeScreenMedAdminState();
}

class _HomeScreenMedAdminState extends State<HomeScreenMedAdmin> {
                  ...
                  child: Container(
                    ...
                    child: Row(
                      ...
                      children: [
                        ...
                        ElevatedButton(
                          onPressed: () {
                              adminService.blocklistUser(userData.id);
