...
import '../services/auth_service_pharmacien.dart';
...
class AuthScreenPharmacien extends StatefulWidget {
  static const String routeName = 'auth-screen-pharmacien';
  const AuthScreenPharmacien({super.key});

  @override
  State<AuthScreenPharmacien> createState() => _AuthScreenPharmacienState();
}


class _AuthScreenPharmacienState extends State<AuthScreenPharmacien> {
  Auth _auth = Auth.signin;
  String selectedSpecialite = GlobalVariables.specialite[0];
  final _signUpFormKey = GlobalKey<FormState>();
  final _signInFormKey = GlobalKey<FormState>();
  final AuthServicePharmacien authServicePharmacien = AuthServicePharmacien();
  ...
  void signUpMedecin() {
    ...
    authServicePharmacien.signUpPharmacien(
      context: context,
  ...
  void signInMedecin() {
    authServicePharmacien.signInPharmacien(
      context: context,
      email: _emailController.text,
      password: _passwordController.text,
    );
